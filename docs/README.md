...
**Current version: v2.5.1**. See [CHANGELOG](CHANGELOG.md) for the complete change log.
...
To add a language or improve an existing translation, see [CONTRIBUTING](CONTRIBUTING.md).
...
| --- | --- |
| [CHANGELOG](CHANGELOG.md) | Complete version history and details of fixes in each version |
| [CONTRIBUTING](CONTRIBUTING.md) | Contribution process, coding style, and release process |
...
| --- | --- | --- | --- | --- |
| English | `docs/README.md` | `CHANGELOG.md` | `CONTRIBUTING.md` | Manually maintained |
| Simplified Chinese | `docs/README.zh-CN.md` | `CHANGELOG.zh-CN.md` | `CONTRIBUTING.zh-CN.md` | **Authoritative Source** |
| Traditional Chinese | `docs/README.zh-TW.md` | `CHANGELOG.zh-TW.md` | `CONTRIBUTING.zh-TW.md` | Manually maintained |
| Japanese | `docs/README.ja-JP.md` | `CHANGELOG.ja-JP.md` | `CONTRIBUTING.ja-JP.md` | Manually maintained |
| Korean | `docs/README.ko-KR.md` | `CHANGELOG.ko-KR.md` | `CONTRIBUTING.ko-KR.md` | Manually maintained |

> Simplified Chinese is the authoritative source; the source file itself is the Simplified Chinese version, so no separate `README.zh-CN.md` exists.
