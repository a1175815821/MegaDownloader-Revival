...
> Restoring the classic MEGA Downloader to working order. Based on a decompiled version of v1.8 source code, with ongoing fixes — see [CHANGELOG](CHANGELOG.md).
...
**Current version: v2.5.3**. See [CHANGELOG](CHANGELOG.md) for the complete change log.
...
| Simplified Chinese | `README.zh-CN.md` | `CHANGELOG.md` | `CONTRIBUTING.zh-CN.md` |
| Traditional Chinese | `README.zh-TW.md` | `CHANGELOG.md` | `CONTRIBUTING.md` |
| Japanese | `README.ja-JP.md` | `CHANGELOG.md` | `CONTRIBUTING.md` |
| Korean | `README.ko-KR.md` | `CHANGELOG.md` | `CONTRIBUTING.md` |
