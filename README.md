...
> 基于 MegaDownloader v1.8 反编译源码修复而成。v2.1 在 v2.0 主题框架上完善深色模式(列表/进度条/按钮边框/菜单等),使其真正可用;v2.0 完成 4 阶段 60+ 项修复与深/浅色主题切换。
...
- **多语言界面**:支持 10 种语言,可扩展
- **深/浅色主题**:支持跟随系统或手动切换;v2.1 完善深色列表/按钮/菜单等
...
1. 从 [Releases](../../releases) 下载最新 `MegaDownloader-Revival-v2.1.0-win-x86.zip`
2. 解压到任意目录(无需安装,绿色版)
