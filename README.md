...
- **v2.4**(2026-08-14~26):21 项 bug 修复(2.4.0);下载完成误报错误修复(2.4.1);下载文件真实损坏修复——MetaMAC 算法对齐 MEGA SDK 线性分块调度、mismatch 宽松策略、非对齐续传 CTR 密钥流错位防护(2.4.2);7z 解压支持(内置 7zr.exe)、Web 局域网推送开关、剪贴板网页复制漏检修复(2.4.3)
