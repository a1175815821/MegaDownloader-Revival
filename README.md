...
> 基于 MegaDownloader v1.8 反编译源码修复而成。v2.0 在 v1.9 链接格式修复的基础上,完成 4 阶段 60+ 项修复,涵盖安全加固、资源泄漏、代码清理与全新深/浅色主题切换。
...
1. 从 [Releases](../../releases) 下载最新 `MegaDownloader-Revival-v2.0.0-win-x86.zip`
2. 解压到任意目录(无需安装,绿色版)
3. 双击运行 `MegaDownloader.exe`
4. 复制 MEGA 链接,程序会自动识别剪贴板内容
5. 也可点击工具栏 **添加链接** 按钮手动粘贴
6. 配置下载目录、并发数、限速等选项于 **设置** 窗口
7. 在 **设置 → 常规 → 主题** 中切换深/浅色(v2.0 新增)
